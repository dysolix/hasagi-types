...
export interface LCUWebSocketEvents {
	...
	"OnJsonApiEvent_lol-event-shop_v1_categories-offers": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_event-details-data": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_failure-loading-reward-track": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_failure-loading-token-shop": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_info": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_is-grace-period": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_navigation-button-data": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_pass-background-data": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_progress-info-data": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_reward-track-bonus-items": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_reward-track-bonus-progress": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_reward-track-items": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_reward-track-progress": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_reward-track-xp": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_token-balance": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_token-shop-data": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_token-upsell": LCUTypes.PluginResourceEvent,
	"OnJsonApiEvent_lol-event-shop_v1_unclaimed-rewards": LCUTypes.PluginResourceEvent,
	...
	"OnJsonApiEvent_lol-honor-v2_v1_reward-granted": LCUTypes.PluginResourceEvent,
	...
	"OnJsonApiEvent_lol-marketing-preferences_v1_partition": LCUTypes.PluginResourceEvent,
